...
// DOM Elements
let studyGrid, reviewGrid, completedGrid, shuffleBtn, navItems, views, searchInput, clearSearchBtn, searchBtn, aiResponse, aiResponseBody, closeAi;
let sentenceZone, zoneContent, refreshSentenceBtn;
...
function init() {
    ...
    if (!studyGrid) {
        console.error("Study grid not found!");
    } else {
        console.log("Study grid found:", studyGrid);
    }
    shuffleCards();
    setupEventListeners();
}
...
function setupDOMElements() {
    ...
    aiResponseBody = document.getElementById('aiResponseBody');
    closeAi = document.querySelector('.close-ai');
    
    // Sentence Zone
    sentenceZone = document.getElementById('sentenceZone');
    zoneContent = document.getElementById('zoneContent');
    refreshSentenceBtn = document.getElementById('refreshSentenceBtn');
}
...
function renderGrid(gridElement, cards, type) {
    console.log("Rendering grid...", cards.length, type);
    if (!gridElement) {
        console.error("Grid element is null in renderGrid");
        return;
    }
...
// sentenceZone, zoneContent, refreshSentenceBtn are defined in setupDOMElements()
